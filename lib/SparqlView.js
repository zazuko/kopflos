...
class SparqlView extends ApiObject {
  constructor (options) {
    ...
    this.code = this.valueTerm(ns.hydraView.code)
    this.source = this.valueTerm(ns.hydraView.source, this.code)
    this.variables = this.valueTerm(ns.hydraView.variables)
